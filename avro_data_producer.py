...
kafka_config = {
    ...
    'sasl.username': 'M43PK6LS42BMAKVQ',
    'sasl.password': 'DzVdSMIWsy5BkfZbniu66yHGRcsLuAjYDChXPNyZ8a+sBjZeJP/YtZ8A35cZHnxH'
}

# Create a Schema Registry client
schema_registry_client = SchemaRegistryClient({
  'url': 'https://psrc-4r3xk.us-east-2.aws.confluent.cloud',
  'basic.auth.user.info': '{}:{}'.format('5L6FZPA6FYTOCN7Y', 'gDzDrNouOvExEJBatVVsVF2GQeY90+fBMSpHOf7CBNpO9GVhTlI/IKwAwnpWA2p9')
})
